...
if __name__ == '__main__':
    ...
    multiple_choice_question = MultipleChoiceQuestion(prompt="Who is the best?", choices={"A": 'Mike', "B": 'Domingo'},
                                                      answer='A')
    '''
    multiple_choice_question.ask_for_responses() 
        dispatch_to_response -> get_a_response(self)
            instantiate a data structure explaining what is required -> Question and Quiz. This is a case of Mediator
    '''
